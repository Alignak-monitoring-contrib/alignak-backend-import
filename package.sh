...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak-Backend-Import thanks to the fpm
...
pkg_name="${python_prefix}-alignak-backend-import"
pkg_description="Alignak backend importation script for Nagios configuration files"
pkg_url="http://alignak.net"
pkg_team="Alignak Team (contact@alignak.net)"

version=`python -c "from alignak_backend_import import __version__;print(__version__)"`
